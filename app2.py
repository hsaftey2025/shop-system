...
# 2. دالة الاتصال الرسمية والنظيفة التي تقرأ من الـ Secrets مباشرة
@st.cache_resource
def init_connection():
    scope = ["https://spreadsheets.google.com/feeds", "https://www.googleapis.com/auth/drive"]
    
    # جلب الإعدادات وتحويلها لقاموس بايثون قياسي
    creds_dict = dict(st.secrets["gspread_creds"])
    
    if "private_key" in creds_dict:
        # تحويل رموز السطر الجديد النصية لأسطر حقيقية يفهمها نظام التشفير
