...
# 2. المفتاح الثابت والنهائي الموزع برمجياً لحل مشكلة الـ PEM والـ Padding نهائياً
PRIVATE_KEY_FIXED = (
    "-----BEGIN PRIVATE KEY-----\n"
...
def init_connection():
    ...
    # بناء القاموس كاملاً وبشكل مباشر من الكود والـ Secrets البسيطة المتبقية
    creds_dict = {
        "type": "service_account",
        "project_id": "shop-management-system-496511",
        "private_key_id": "c4c26a6e78c0d6390481ed3c1345f16449bd451c",
        ...
        "private_key": PRIVATE_KEY_FIXED  # استخدام المتغير الثابت والمقسّم برمجياً بدقة
    }
